...
const WHY_CARDS = [
  ...
  {
    title: "Admin Center",
    desc: "🚨 CRITICAL REGRESSION BUG – ADMIN PANEL SHOWING DEMO DATA\n\nBefore the Mini Store implementation, the Admin Dashboard was displaying REAL users from Supabase.\n\nAfter recent updates, all Admin modules are showing hardcoded demo/sample data instead.\n\nExample:\nRajesh Kumar\nPriya Sharma\nAmit Patel\n\nThese users do NOT exist in production.\n\nMeanwhile, the actual application contains real users and real Bio Pages.\n\nExample:\n- gaurav.rbl35@gmail.com\n- Real Bio Pages\n- Real subscriptions\n- Real plans\n\nThe Admin Panel must NEVER display demo data.\n\nFix the following immediately:\n\n1. Remove every hardcoded array, mock JSON and sample dataset from:\n- User Management\n- Subscription Manager\n- License Manager\n- Dashboard cards\n- Revenue widgets\n- Analytics\n- Monitoring\n\n2. Connect all Admin modules directly to Supabase.\n\n3. User Management must show:\n- Real users\n- Email\n- Registration date\n- Last login\n- Current Plan\n- Trial status\n- Account status\n- Number of Bio Pages\n\n4. Subscription Manager must show:\n- Real subscription\n- Trial\n- Plan\n- Expiry\n- Renewal\n- Payment status\n\n5. Dashboard statistics must calculate from live database.\n\nExamples:\nTotal Users\nActive Users\nBio Pages\nMini Stores\nBookings\nRevenue\nSubscriptions\n\n6. Remove every placeholder user permanently.\n\n7. If no production data exists,\nshow:\n\n\"No records found\"\n\ninstead of fake users.\n\n8. Verify every Admin table is reading from Supabase.\n\n9. Ensure all Admin pages update automatically when a new user registers or upgrades.\n\n10. Perform a full Admin Data Integrity Audit and remove ALL remaining mock/demo data from the project.\n\nThis is a production system.\n\nNo hardcoded demo data should remain anywhere in the Admin Panel.",
    icon: MapPin,
    grad: "from-rose-500 to-orange-500",
    span: "sm:col-span-1",
  },
