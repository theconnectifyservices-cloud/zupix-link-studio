...
export function CtaButton({ 
  ...
  const baseStyles = cn(
    "group relative inline-flex items-center justify-center min-h-[52px] sm:min-h-[58px] px-6 sm:px-[34px] rounded-[18px] sm:rounded-full text-white font-bold transition-all duration-[250ms] hover:-translate-y-[2px] hover:scale-[1.02] active:scale-[0.98] cursor-pointer outline-none select-none overflow-hidden text-[13px] min-[360px]:text-sm sm:text-base whitespace-nowrap",
    isPrimary 
      ...
      : "bg-white/5 border border-white/10 hover:bg-white/10 hover:border-[#FF2DAA]/50",
    className
  );
