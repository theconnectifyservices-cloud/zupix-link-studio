...
const PLANS: Plan[] = [
  {
    id: "starter",
    name: "Starter",
    tagline: "For creators & solo founders getting online.",
    monthly: 0,
    yearly: 0,
    features: [
      "1 bio page",
  ...
  },
  {
    id: "pro",
    name: "Professional",
    tagline: "For growing businesses & Instagram-first brands.",
    monthly: 499,
    yearly: 4990,
    recommended: true,
    features: [
  ...
  },
  {
    id: "enterprise",
    name: "Enterprise",
    tagline: "For agencies, franchises & multi-brand teams.",
    monthly: 2499,
    yearly: 24990,
    features: [
      "Unlimited bio pages & workspaces",
      "500 GB media + CDN",
      "White-label + reseller portal",
      "10 custom domains",
      "SSO, RBAC, audit logs",
      "0% platform fee on UPI",
...
function PricingCard({ plan, yearly, i }: { plan: Plan; yearly: boolean; i: number }) {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -8 }}
      className={cx(
        "relative flex flex-col overflow-hidden rounded-3xl border p-7 backdrop-blur-xl transition-shadow",
        plan.recommended
          ? "border-transparent bg-background/70 shadow-[0_30px_80px_-30px_rgba(232,67,147,0.55)]"
          : "border-foreground/10 bg-background/50 hover:shadow-[0_20px_60px_-30px_rgba(0,0,0,0.4)]",
      )}
    >
      {plan.recommended && (
        <>
          <div
            ...
            style={{
              background:
                "conic-gradient(from 180deg at 50% 50%, #ff6b35, #e84393, #6c5ce7, #22d3ee, #ff6b35)",
              WebkitMask:
          ...
          <div
            ...
            style={{
              background: "linear-gradient(135deg, #ff6b3555, #e8439355, #6c5ce755)",
            }}
          />
          <motion.div
            aria-hidden
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle at 20% 20%, rgba(255,107,53,0.18), transparent 40%), radial-gradient(circle at 80% 80%, rgba(108,92,231,0.18), transparent 40%)",
      ...
      <div className="relative">
        {plan.recommended && (
          <div className="mb-4 inline-flex items-center gap-1 rounded-full bg-gradient-to-r from-[#ff6b35] to-[#6c5ce7] px-3 py-1 text-[11px] font-bold uppercase tracking-wide text-white shadow-lg">
        ...
        <div className="mt-6 flex items-baseline gap-1">
          <span className="text-[13px] font-medium text-foreground/60">₹</span>
          <span className="text-5xl font-medium tabular-nums" style={{ fontFamily: "'Instrument Serif', serif" }}>
        ...
        {yearly && plan.monthly > 0 && (
          <div className="mt-1 text-xs text-emerald-600 dark:text-emerald-400">
            Save {inr(plan.monthly * 12 - plan.yearly)} vs monthly
          </div>
        )}

        <div className="my-6 h-px bg-gradient-to-r from-transparent via-foreground/10 to-transparent" />
            ...
            <li key={f} className="flex items-start gap-2 text-sm">
              <span
                className={cx(
                  ...
                  plan.recommended
                    ? "bg-gradient-to-br from-[#ff6b35] to-[#6c5ce7] text-white"
    ...
    <section className="relative py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6">
        <SectionHeader
          ...
          subtitle="Start free. Upgrade when your business is ready. No hidden fees."
        />

        <div className="mt-8 flex items-center justify-center gap-3">
          <span className={cx("text-sm", !yearly && "font-semibold")}>Monthly</span>
          <button
            role="switch"
            aria-checked={yearly}
            ...
            className={cx(
              ...
              yearly ? "bg-gradient-to-r from-[#ff6b35] to-[#6c5ce7]" : "bg-foreground/15",
            )}
          >
            <motion.span
              layout
          ...
          <span className={cx("text-sm", yearly && "font-semibold")}>
            Yearly <span className="text-emerald-600 dark:text-emerald-400">(save ~17%)</span>
          </span>
        </div>

        <div className="mx-auto mt-12 grid max-w-6xl grid-cols-1 gap-6 md:grid-cols-3">
          {PLANS.map((p, i) => (
            <PricingCard key={p.id} plan={p} yearly={yearly} i={i} />
          ))}
        </div>
      </div>
    </section>
        ...
        <div className="relative overflow-hidden rounded-[36px] border border-white/10 p-10 sm:p-16 md:p-20">
          ...
          <div className="relative text-center text-white">
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
              <MagneticButton href="/auth" icon={<ArrowRight className="h-4 w-4" />}>
                Start Building — Free
              </MagneticButton>
