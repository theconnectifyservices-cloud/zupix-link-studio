 ...
 */
const RU = (gender, n, size = 240) => `https://randomuser.me/api/portraits/${gender}/${n}.jpg?w=${size}`;
const UN = (id, w = 1200, h = 800) => `https://images.unsplash.com/photo-${id}?w=${w}&h=${h}&fit=crop&auto=format&q=80`;
/**
...
const p = (id) => UN(id, 600, 600);
const g = (id) => UN(id, 800, 600);
...
export function mediaForCategory(label) {
